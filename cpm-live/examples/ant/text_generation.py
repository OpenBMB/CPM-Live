...
if __name__ == "__main__":
    ...
    texts = ["神舟十四号3名航天员在轨期间，各项工作顺利推进。刚刚在轨度过中秋佳节的他们，正在为第二次出舱活动积极准备中，",
    ...
    beam_search = CPMAntBeamSearch(model=model, tokenizer=tokenizer, prompt_length=config.prompt_length)
